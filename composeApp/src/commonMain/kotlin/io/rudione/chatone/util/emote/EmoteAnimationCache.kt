...
object EmoteAnimationCache {
    ...
    private val animationStates = HashMap<String, Animatable<Float, *>>()
    private val animationSpecs = HashMap<String, AnimationSpec<Float>>()
    private val tooltipTimings = HashMap<String, Long>()
    ...
    fun getOrCreateAnimation(
        ...
        touch(emoteId)
        return animationStates.getOrPut(emoteId) { Animatable(initialValue) }
    }
